...
public class BigReactorsCows extends BaseCowHandler {
    ...
    public List<CowsRegistryItem> registerCows() {
        ...
        yelloriumCow = tryAddCow("YelloriumCow", 500, "yellorium", 0xE5FF00, 0xA6A600, SpawnType.NORMAL,
            new String[] { "en_US:Yellorium Cow", "ja_JP:イエローリウム牛" });
        allCows.add(yelloriumCow);

        cyaniteCow = tryAddCow("CyaniteCow", 501, "cyanite", 0x66CCFF, 0x3399CC, SpawnType.NORMAL,
            new String[] { "en_US:Cyanite Cow", "ja_JP:シアナイト牛" });
        allCows.add(cyaniteCow);

        steamCow = tryAddCow("SteamCow", 502, "steam", 0xCCCCCC, 0xFFFFFF, SpawnType.NORMAL,
